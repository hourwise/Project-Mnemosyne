...
| ---------------------------------------------- | ------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------ |
| Source file scanned -> source artifact indexed | `OnboardingEngine.onboard()`                                              | File contents, relative path, classified source type, SHA-256 content hash                                            | Ignores `.git`, `.project-Mnemosyne`, `node_modules`, large files, and non-indexed extensions           | `PROJECT_ONBOARDED` summary audit event                                                                                    | Re-run onboarding with new sources                                   | None by itself                                                                                    | Indexing does not grant trust; it only establishes source identity                               |
